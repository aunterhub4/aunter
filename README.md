...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Aunter Hub BF Premium') then
        makefolder('Aunter Hub BF Premium')
    end
    if not _G.Dis and not isfile('Aunter Hub BF Premium/'..Name..'.json') then
        writefile('Aunter Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Aunter Hub BF Premium') and isfile('Aunter Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Aunter Hub BF Premium/'..Name..'.json'))
...
local win = library:Window("Aunter",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
...
local Credit_Tab = win:Tab("Credit",[[6034684949]])

Credit_Tab:Label("Credit")
...
Credit_Tab:Button("OSMRAUTOFIRE#1380",function()
end)
spawn(function()
    while wait(1) do
		pcall(function()
